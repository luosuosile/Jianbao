...
public class HttpUtil {
    ...
    private static APIService apiService;//这两个是介入口
    private static APIService weiboService;//接入口
    ...
    public static void getNews(final OnGetListener listener) {//这个被用在了服务里面
    ...
    private static APIService getAPIService() {
        if (apiService == null){
            String storyBaseUrl = "http://news-at.zhihu.com/api/4/";//这就是基本API
